                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row justify-content-center m-0 p-0">
                                        <div class="col-12 text-left m-0 p-0">
                                            ...
                                            <h3>Referencia</h3>
                                            <input type="text" placeholder="Referencia" class="form-control mb-2 text-left" v-model="payment.reference" disabled>
                                            <h3>Monto</h3>
                                            <input type="text" placeholder="Monto" class="form-control mb-2 text-left" v-model="payment.amount" disabled>
                                            <h3>Comentario</h3>
                                            <input type="text" placeholder="Referencia" class="form-control mb-2 text-left" v-model="payment.comments" disabled>
...
<script>
    export default {
        ...
        methods: {
            setEditView(){
                window.location.href="/admin/payments/editar/"+this.payment.id;
            },
            showList(){
