            ...
            <table class="table my-0">
              <thead>
                <tr class="text-center">
                  ...
                  <th @click="sort(2)">Nombre de la disciplina</th>
                  <th @click="sort(3)">Nombre del área</th>
                  <th>Acciones</th>
                </tr>
              </thead>
              <tbody>
...
export default {
  ...
  mounted() {
    axios.get("/admin/disciplinas").then((res) => {
  ...
  methods: {
    ...
    onClickEdit($idy) {
      const ediId = $idy;
      window.location.href = "/admin/disciplinas/editar/" + ediId + "/";
      //this.$emit("edit", ediId);
    },
    onClickDetails($idy) {
      const ediId = $idy;
      window.location.href = "/admin/disciplinas/" + ediId + "/";
    ...
    onClickDelete($idc, $iddel) {
      this.$confirm("Realmente desea eliminar la disciplina", "Alerta", {
    ...
    addDiscip() {
      window.location.href = "/admin/disciplinas/agregar/";
    },
  },
};
</script>